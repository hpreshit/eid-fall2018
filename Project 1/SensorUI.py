...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.humidityLabel.setGeometry(QtCore.QRect(490, 190, 81, 81))
        ...
        self.temperatureDisplay.setGeometry(QtCore.QRect(75, 280, 151, 61))
        self.temperatureDisplay.setObjectName("temperatureDisplay")
        self.humidityDisplay = QtWidgets.QLCDNumber(Form)
        self.humidityDisplay.setGeometry(QtCore.QRect(455, 280, 151, 61))
